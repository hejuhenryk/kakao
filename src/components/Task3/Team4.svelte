...
<section class="restricted skin-vector skin-vector-search-vue mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject mw-editable page-Kakao rootpage-Kakao skin-vector-2022 action-view uls-dialog-sticky-hide"><a class="mw-jump-link" href="#bodyContent">Hopp til innhold</a>
        ...
        <div id="p-navigation" class="vector-menu mw-portlet mw-portlet-navigation">
            ...
            <div class="vector-menu-content">
                ...
                <ul class="vector-menu-content-list">
                    ...
                    <li id="n-mainpage-description" class="mw-list-item"><a href="/wiki/Portal:Forside" title="Gå til hovedsiden [Alt+Shift+z]" accesskey="z"><span>Forside</span></a></li><li id="n-svaksynte" class="mw-list-item"><a href="/wiki/Wikipedia:Svaksynte"><span>Svaksynte</span></a></li><li id="n-UA" class="mw-list-item"><a href="/wiki/Wikipedia:Utmerkede_artikler"><span>Utmerkede artikler</span></a></li><li id="n-help" class="mw-list-item"><a href="/wiki/Hjelp:Portal" title="Stedet for å få hjelp"><span>Hjelp</span></a></li><li id="n-recentchanges" class="mw-list-item"><a href="/wiki/Spesial:Siste_endringer" title="Liste over siste endringer på wikien. [Alt+Shift+r]" accesskey="r"><span>Siste endringer</span></a></li>
                </ul>
        ...
        <div id="p-prosjekt" class="vector-menu mw-portlet mw-portlet-prosjekt">
            <div class="vector-menu-heading">
                Prosjekt
            </div>
            <div class="vector-menu-content">
                ...
                <ul class="vector-menu-content-list">
                    ...
                    <li id="n-Stilmanual" class="mw-list-item"><a href="/wiki/Wikipedia:Stilmanual"><span>Stilmanual</span></a></li><li id="n-Prosjektportal" class="mw-list-item"><a href="/wiki/Wikipedia:Portal"><span>Prosjektportal</span></a></li><li id="n-tinget" class="mw-list-item"><a href="/wiki/Wikipedia:Tinget"><span>Tinget</span></a></li><li id="n-torget" class="mw-list-item"><a href="/wiki/Wikipedia:Torget"><span>Torget</span></a></li><li id="n-Nybegynnerforum" class="mw-list-item"><a href="/wiki/Wikipedia:Nybegynnerforum"><span>Nybegynnerforum</span></a></li><li id="n-notiser" class="mw-list-item"><a href="/wiki/Wikipedia:Notiser"><span>Notiser</span></a></li><li id="n-konkurranser" class="mw-list-item"><a href="/wiki/Wikipedia:Konkurranser"><span>Konkurranser</span></a></li><li id="n-randompage" class="mw-list-item"><a href="/wiki/Spesial:Tilfeldig" title="Vis en tilfeldig side [Alt+Shift+x]" accesskey="x"><span>Tilfeldig side</span></a></li>
                </ul>
                
            </div>
        </div>
        
        <div id="p-Wikipedia" class="vector-menu mw-portlet mw-portlet-Wikipedia">
            <div class="vector-menu-heading">
                Wikipedia
            </div>
            <div class="vector-menu-content">
                ...
                <ul class="vector-menu-content-list">
                    ...
                    <li id="n-kontakt" class="mw-list-item"><a href="/wiki/Wikipedia:Kontakt"><span>Kontakt Wikipedia</span></a></li><li id="n-sitesupport" class="mw-list-item"><a href="//donate.wikimedia.org/wiki/Special:FundraiserRedirector?utm_source=donate&amp;utm_medium=sidebar&amp;utm_campaign=C13_no.wikipedia.org&amp;uselang=nb" title="Støtt oss"><span>Doner</span></a></li><li id="n-wmno" class="mw-list-item"><a href="https://www.wikimedia.no" rel="nofollow" title="Medlemsorganisasjon for wikipedianere"><span>Wikimedia Norge</span></a></li>
                </ul>
        ...
        <div class="vector-main-menu-action vector-main-menu-action-lang-alert">
            <div class="vector-main-menu-action-item">
                <div class="vector-main-menu-action-heading vector-menu-heading">Språk</div>
                <div class="vector-main-menu-action-content vector-menu-content">
                    <div class="mw-message-box cdx-message cdx-message--block mw-message-box-notice cdx-message--notice vector-language-sidebar-alert"><span class="cdx-message__icon"></span><div class="cdx-message__content">Språklenker er på toppen av siden ved siden av tittelen.</div></div>
                </div>
            </div>
        </div>
        ...
        <a href="/wiki/Portal:Forside" class="mw-logo">
            <img class="mw-logo-icon" src="/static/images/icons/wikipedia.png" alt="" aria-hidden="true" height="50" width="50">
            <span class="mw-logo-container">
                <img class="mw-logo-wordmark" alt="Wikipedia" src="/static/images/mobile/copyright/wikipedia-wordmark-en.svg" style="width: 7.5em; height: 1.125em;">
                <img class="mw-logo-tagline" alt="" src="/static/images/mobile/copyright/wikipedia-tagline-no.svg" width="121" height="14" style="width: 7.5625em; height: 0.875em;">
            </span>
        </a>
        ...
        <div id="p-search" role="search" class="vector-search-box-vue  vector-search-box-collapses vector-search-box-show-thumbnail vector-search-box-auto-expand-width vector-search-box">
            <a href="/wiki/Spesial:S%C3%B8k" class="cdx-button cdx-button--fake-button cdx-button--fake-button--enabled cdx-button--weight-quiet cdx-button--icon-only search-toggle" id="" title="Søk i Wikipedia [Alt+Shift+f]" accesskey="f"><span class="vector-icon mw-ui-icon-search mw-ui-icon-wikimedia-search"></span>
        ...
        <span>Søk</span>
            ...
            <div class="vector-typeahead-search-container">
                <div class="cdx-typeahead-search cdx-typeahead-search--show-thumbnail cdx-typeahead-search--auto-expand-width">
                    <form action="/w/index.php" id="searchform" class="cdx-search-input cdx-search-input--has-end-button">
                        <div id="simpleSearch" class="cdx-search-input__input-wrapper" data-search-loc="header-moved">
                            <div class="cdx-text-input cdx-text-input--has-start-icon">
                                <input class="cdx-text-input__input" type="search" name="search" placeholder="Søk i Wikipedia" aria-label="Søk i Wikipedia" autocapitalize="sentences" title="Søk i Wikipedia [Alt+Shift+f]" accesskey="f" id="searchInput" autocomplete="off">
                    ...
                    <nav class="vector-user-links vector-user-links-wide" aria-label="Personlig" role="navigation">
        ...
        <div id="p-vector-user-menu-userpage" class="vector-menu mw-portlet emptyPortlet">
            ...
            <nav class="vector-client-prefs-landmark" aria-label="Drakt">
        ...
        <div id="p-vector-user-menu-overflow" class="vector-menu mw-portlet">
            <div class="vector-menu-content">
                ...
                <ul class="vector-menu-content-list">
                    <li id="pt-createaccount-2" class="user-links-collapsible-item mw-list-item user-links-collapsible-item"><a data-mw="interface" href="/w/index.php?title=Spesial:Opprett_konto&amp;returnto=Kakao" title="Du oppfordres til å opprette en konto og logge inn, men det er ikke obligatorisk" class=""><span>Opprett konto</span></a>
        </li>
        <li id="pt-login-2" class="user-links-collapsible-item mw-list-item user-links-collapsible-item"><a data-mw="interface" href="/w/index.php?title=Spesial:Logg_inn&amp;returnto=Kakao" title="Du oppfordres til å logge inn, men det er ikke obligatorisk [Alt+Shift+o]" accesskey="o" class=""><span>Logg inn</span></a>
        </li>
        ...
        <div id="vector-user-links-dropdown" class="vector-dropdown vector-user-menu vector-button-flush-right vector-user-menu-logged-out" title="Flere alternativer">
            <input type="checkbox" id="vector-user-links-dropdown-checkbox" role="button" aria-haspopup="true" data-event-name="ui.dropdown-vector-user-links-dropdown" class="vector-dropdown-checkbox " aria-label="Personlig">
            <label id="vector-user-links-dropdown-label" for="vector-user-links-dropdown-checkbox" class="vector-dropdown-label cdx-button cdx-button--fake-button cdx-button--fake-button--enabled cdx-button--weight-quiet cdx-button--icon-only " aria-hidden="true"><span class="vector-icon mw-ui-icon-ellipsis mw-ui-icon-wikimedia-ellipsis"></span>
        
        <span class="vector-dropdown-label-text">Personlig</span>
            </label>
            <div class="vector-dropdown-content">
        
        
                
        <div id="p-personal" class="vector-menu mw-portlet mw-portlet-personal user-links-collapsible-item" title="Brukermeny">
            <div class="vector-menu-content">
                
                <ul class="vector-menu-content-list">
                    
                    <li id="pt-createaccount" class="user-links-collapsible-item mw-list-item"><a href="/w/index.php?title=Spesial:Opprett_konto&amp;returnto=Kakao" title="Du oppfordres til å opprette en konto og logge inn, men det er ikke obligatorisk"><span class="vector-icon mw-ui-icon-userAdd mw-ui-icon-wikimedia-userAdd"></span> <span>Opprett konto</span></a></li><li id="pt-login" class="user-links-collapsible-item mw-list-item"><a href="/w/index.php?title=Spesial:Logg_inn&amp;returnto=Kakao" title="Du oppfordres til å logge inn, men det er ikke obligatorisk [Alt+Shift+o]" accesskey="o"><span class="vector-icon mw-ui-icon-logIn mw-ui-icon-wikimedia-logIn"></span> <span>Logg inn</span></a></li>
                </ul>
        ...
        <div id="p-user-menu-anon-editor" class="vector-menu mw-portlet mw-portlet-user-menu-anon-editor">
            <div class="vector-menu-heading">
                Sider for utloggede bidragsytere <a href="/wiki/Hjelp:Introduksjon" aria-label="Lær mer om redigering"><span>lær mer</span></a>
            </div>
            <div class="vector-menu-content">
                
                <ul class="vector-menu-content-list">
                    
                    <li id="pt-anoncontribs" class="mw-list-item"><a href="/wiki/Spesial:Mine_bidrag" title="En liste over redigeringer gjort fra denne IP-adressen [Alt+Shift+y]" accesskey="y"><span>Bidrag</span></a></li><li id="pt-anontalk" class="mw-list-item"><a href="/wiki/Spesial:Min_diskusjon" title="Diskusjon om redigeringer fra denne IP-adressen [Alt+Shift+n]" accesskey="n"><span>Brukerdiskusjon</span></a></li>
                </ul>
            ...
            <ul class="vector-toc-contents" id="mw-panel-toc-list">
                <li id="toc-mw-content-text" class="vector-toc-list-item vector-toc-level-1 vector-toc-level-1-active vector-toc-list-item-active">
                    <a href="#" class="vector-toc-link">
                        <div class="vector-toc-text">(Til toppen)</div>
                    </a>
                </li>
                <li id="toc-Bruk" class="vector-toc-list-item vector-toc-level-1 vector-toc-list-item-expanded">
                <a class="vector-toc-link" href="#Bruk">
                    <div class="vector-toc-text">
                    <span class="vector-toc-numb">1</span>Bruk</div>
                </a>
                
                <ul id="toc-Bruk-sublist" class="vector-toc-list">
                </ul>
            </li>
            <li id="toc-Produksjon" class="vector-toc-list-item vector-toc-level-1 vector-toc-list-item-expanded">
                <a class="vector-toc-link" href="#Produksjon">
                    <div class="vector-toc-text">
                    <span class="vector-toc-numb">2</span>Produksjon</div>
                </a>
                
                <ul id="toc-Produksjon-sublist" class="vector-toc-list">
                </ul>
            </li>
            <li id="toc-Innholdsstoffer_i_kakao" class="vector-toc-list-item vector-toc-level-1 vector-toc-list-item-expanded">
                <a class="vector-toc-link" href="#Innholdsstoffer_i_kakao">
                    <div class="vector-toc-text">
                    <span class="vector-toc-numb">3</span>Innholdsstoffer i kakao</div>
                </a>
                
                <ul id="toc-Innholdsstoffer_i_kakao-sublist" class="vector-toc-list">
                </ul>
            </li>
            <li id="toc-Kakao_og_dyr" class="vector-toc-list-item vector-toc-level-1 vector-toc-list-item-expanded">
                <a class="vector-toc-link" href="#Kakao_og_dyr">
                    <div class="vector-toc-text">
                    <span class="vector-toc-numb">4</span>Kakao og dyr</div>
                </a>
                
                <ul id="toc-Kakao_og_dyr-sublist" class="vector-toc-list">
                </ul>
            </li>
            <li id="toc-Se_også" class="vector-toc-list-item vector-toc-level-1 vector-toc-list-item-expanded">
                <a class="vector-toc-link" href="#Se_også">
                    <div class="vector-toc-text">
                    <span class="vector-toc-numb">5</span>Se også</div>
                </a>
                
                <ul id="toc-Se_også-sublist" class="vector-toc-list">
                </ul>
            </li>
            <li id="toc-Referanser" class="vector-toc-list-item vector-toc-level-1 vector-toc-list-item-expanded">
                <a class="vector-toc-link" href="#Referanser">
                    <div class="vector-toc-text">
                    <span class="vector-toc-numb">6</span>Referanser</div>
                </a>
                
                <ul id="toc-Referanser-sublist" class="vector-toc-list">
                </ul>
            </li>
            <li id="toc-Eksterne_lenker" class="vector-toc-list-item vector-toc-level-1 vector-toc-list-item-expanded">
                <a class="vector-toc-link" href="#Eksterne_lenker">
                    <div class="vector-toc-text">
                    <span class="vector-toc-numb">7</span>Eksterne lenker</div>
                </a>
                
                <ul id="toc-Eksterne_lenker-sublist" class="vector-toc-list">
                </ul>
            </li>
        </ul>
        </div>
        ...
        <span class="vector-dropdown-label-text">Vis/skjul innholdsfortegnelsen</span>
            ...
            <div class="vector-dropdown-content">
                            ...
                            <h1 id="firstHeading" class="firstHeading mw-first-heading"><span class="mw-page-title-main">Kakao</span></h1>
                                    
        <div id="p-lang-btn" class="vector-dropdown mw-portlet mw-portlet-lang">
            <input type="checkbox" id="p-lang-btn-checkbox" role="button" aria-haspopup="true" data-event-name="ui.dropdown-p-lang-btn" class="vector-dropdown-checkbox mw-interlanguage-selector" aria-label="Gå til en artikkel på et annet språk. Tilgjengelig på 44 språk">
        ...
        <span class="vector-dropdown-label-text">44 språk</span>
            </label>
            <div class="vector-dropdown-content">
                ...
                <div class="vector-menu-content">
                    ...
                    <ul class="vector-menu-content-list">
                        ...
                        <li class="interlanguage-link interwiki-nn mw-list-item" style=""><a href="https://nn.wikipedia.org/wiki/Kakao" title="Kakao – norsk nynorsk" lang="nn" hreflang="nn" class="interlanguage-link-target"><span>Norsk nynorsk</span></a></li><li class="interlanguage-link interwiki-fo mw-list-item" style=""><a href="https://fo.wikipedia.org/wiki/Kakao" title="Kakao – færøysk" lang="fo" hreflang="fo" class="interlanguage-link-target"><span>Føroyskt</span></a></li><li class="interlanguage-link interwiki-af mw-list-item" style="display: none;"><a href="https://af.wikipedia.org/wiki/Kakaoboon" title="Kakaoboon – afrikaans" lang="af" hreflang="af" class="interlanguage-link-target"><span>Afrikaans</span></a></li><li class="interlanguage-link interwiki-ar badge-Q70894304 mw-list-item" title="" style=""><a href="https://ar.wikipedia.org/wiki/%D9%83%D8%A7%D9%83%D8%A7%D9%88" title="كاكاو – arabisk" lang="ar" hreflang="ar" class="interlanguage-link-target"><span>العربية</span></a></li><li class="interlanguage-link interwiki-ca mw-list-item" style="display: none;"><a href="https://ca.wikipedia.org/wiki/Gra_de_cacau" title="Gra de cacau – katalansk" lang="ca" hreflang="ca" class="interlanguage-link-target"><span>Català</span></a></li><li class="interlanguage-link interwiki-cs mw-list-item" style="display: none;"><a href="https://cs.wikipedia.org/wiki/Kakao" title="Kakao – tsjekkisk" lang="cs" hreflang="cs" class="interlanguage-link-target"><span>Čeština</span></a></li><li class="interlanguage-link interwiki-de mw-list-item" style="display: none;"><a href="https://de.wikipedia.org/wiki/Kakaobohne" title="Kakaobohne – tysk" lang="de" hreflang="de" class="interlanguage-link-target"><span>Deutsch</span></a></li><li class="interlanguage-link interwiki-et mw-list-item" style="display: none;"><a href="https://et.wikipedia.org/wiki/Kakaopuu_seemned" title="Kakaopuu seemned – estisk" lang="et" hreflang="et" class="interlanguage-link-target"><span>Eesti</span></a></li><li class="interlanguage-link interwiki-el mw-list-item" style="display: none;"><a href="https://el.wikipedia.org/wiki/%CE%9A%CE%B1%CE%BA%CE%AC%CE%BF" title="Κακάο – gresk" lang="el" hreflang="el" class="interlanguage-link-target"><span>Ελληνικά</span></a></li><li class="interlanguage-link interwiki-en mw-list-item" style=""><a href="https://en.wikipedia.org/wiki/Cocoa_bean" title="Cocoa bean – engelsk" lang="en" hreflang="en" class="interlanguage-link-target"><span>English</span></a></li><li class="interlanguage-link interwiki-es mw-list-item" style=""><a href="https://es.wikipedia.org/wiki/Grano_de_cacao" title="Grano de cacao – spansk" lang="es" hreflang="es" class="interlanguage-link-target"><span>Español</span></a></li><li class="interlanguage-link interwiki-eo mw-list-item" style="display: none;"><a href="https://eo.wikipedia.org/wiki/Kakao" title="Kakao – esperanto" lang="eo" hreflang="eo" class="interlanguage-link-target"><span>Esperanto</span></a></li><li class="interlanguage-link interwiki-eu mw-list-item" style="display: none;"><a href="https://eu.wikipedia.org/wiki/Kakao" title="Kakao – baskisk" lang="eu" hreflang="eu" class="interlanguage-link-target"><span>Euskara</span></a></li><li class="interlanguage-link interwiki-fa mw-list-item" style="display: none;"><a href="https://fa.wikipedia.org/wiki/%DA%A9%D8%A7%DA%A9%D8%A7%D8%A6%D9%88" title="کاکائو – persisk" lang="fa" hreflang="fa" class="interlanguage-link-target"><span>فارسی</span></a></li><li class="interlanguage-link interwiki-fr mw-list-item" style="display: none;"><a href="https://fr.wikipedia.org/wiki/F%C3%A8ve_de_cacao" title="Fève de cacao – fransk" lang="fr" hreflang="fr" class="interlanguage-link-target"><span>Français</span></a></li><li class="interlanguage-link interwiki-ko mw-list-item" style="display: none;"><a href="https://ko.wikipedia.org/wiki/%EC%BD%94%EC%BD%94%EC%95%84%EC%BD%A9" title="코코아콩 – koreansk" lang="ko" hreflang="ko" class="interlanguage-link-target"><span>한국어</span></a></li><li class="interlanguage-link interwiki-hi mw-list-item" style=""><a href="https://hi.wikipedia.org/wiki/%E0%A4%95%E0%A5%8B%E0%A4%95%E0%A5%8B" title="कोको – hindi" lang="hi" hreflang="hi" class="interlanguage-link-target"><span>हिन्दी</span></a></li><li class="interlanguage-link interwiki-io mw-list-item" style="display: none;"><a href="https://io.wikipedia.org/wiki/Kakao" title="Kakao – ido" lang="io" hreflang="io" class="interlanguage-link-target"><span>Ido</span></a></li><li class="interlanguage-link interwiki-id mw-list-item" style=""><a href="https://id.wikipedia.org/wiki/Biji_kakao" title="Biji kakao – indonesisk" lang="id" hreflang="id" class="interlanguage-link-target"><span>Bahasa Indonesia</span></a></li><li class="interlanguage-link interwiki-he mw-list-item" style="display: none;"><a href="https://he.wikipedia.org/wiki/%D7%A7%D7%A7%D7%90%D7%95" title="קקאו – hebraisk" lang="he" hreflang="he" class="interlanguage-link-target"><span>עברית</span></a></li><li class="interlanguage-link interwiki-pam mw-list-item" style="display: none;"><a href="https://pam.wikipedia.org/wiki/Cacao" title="Cacao – pampanga" lang="pam" hreflang="pam" class="interlanguage-link-target"><span>Kapampangan</span></a></li><li class="interlanguage-link interwiki-kk mw-list-item" style="display: none;"><a href="https://kk.wikipedia.org/wiki/%D0%9A%D0%B0%D0%BA%D0%B0%D0%BE_%D0%B1%D2%B1%D1%80%D1%88%D0%B0%D2%9B%D1%82%D0%B0%D1%80%D1%8B" title="Какао бұршақтары – kasakhisk" lang="kk" hreflang="kk" class="interlanguage-link-target"><span>Қазақша</span></a></li><li class="interlanguage-link interwiki-lt mw-list-item" style="display: none;"><a href="https://lt.wikipedia.org/wiki/Kakava" title="Kakava – litauisk" lang="lt" hreflang="lt" class="interlanguage-link-target"><span>Lietuvių</span></a></li><li class="interlanguage-link interwiki-ms mw-list-item" style="display: none;"><a href="https://ms.wikipedia.org/wiki/Biji_koko" title="Biji koko – malayisk" lang="ms" hreflang="ms" class="interlanguage-link-target"><span>Bahasa Melayu</span></a></li><li class="interlanguage-link interwiki-nah mw-list-item" style="display: none;"><a href="https://nah.wikipedia.org/wiki/Cacahuatetl_(Xinachtli)" title="Cacahuatetl (Xinachtli) – nahuatl" lang="nah" hreflang="nah" class="interlanguage-link-target"><span>Nāhuatl</span></a></li><li class="interlanguage-link interwiki-nl mw-list-item" style="display: none;"><a href="https://nl.wikipedia.org/wiki/Cacaoboon" title="Cacaoboon – nederlandsk" lang="nl" hreflang="nl" class="interlanguage-link-target"><span>Nederlands</span></a></li><li class="interlanguage-link interwiki-nds-nl mw-list-item" style="display: none;"><a href="https://nds-nl.wikipedia.org/wiki/Kakouboon" title="Kakouboon – nedersaksisk" lang="nds-NL" hreflang="nds-NL" class="interlanguage-link-target"><span>Nedersaksies</span></a></li><li class="interlanguage-link interwiki-pl mw-list-item" style="display: none;"><a href="https://pl.wikipedia.org/wiki/Kakao" title="Kakao – polsk" lang="pl" hreflang="pl" class="interlanguage-link-target"><span>Polski</span></a></li><li class="interlanguage-link interwiki-pt mw-list-item" style="display: none;"><a href="https://pt.wikipedia.org/wiki/Gr%C3%A3o_de_cacau" title="Grão de cacau – portugisisk" lang="pt" hreflang="pt" class="interlanguage-link-target"><span>Português</span></a></li><li class="interlanguage-link interwiki-ro mw-list-item" style="display: none;"><a href="https://ro.wikipedia.org/wiki/Cacao" title="Cacao – rumensk" lang="ro" hreflang="ro" class="interlanguage-link-target"><span>Română</span></a></li><li class="interlanguage-link interwiki-ru mw-list-item" style=""><a href="https://ru.wikipedia.org/wiki/%D0%9A%D0%B0%D0%BA%D0%B0%D0%BE-%D0%B1%D0%BE%D0%B1%D1%8B" title="Какао-бобы – russisk" lang="ru" hreflang="ru" class="interlanguage-link-target"><span>Русский</span></a></li><li class="interlanguage-link interwiki-sco mw-list-item" style="display: none;"><a href="https://sco.wikipedia.org/wiki/Cocoa_bean" title="Cocoa bean – skotsk" lang="sco" hreflang="sco" class="interlanguage-link-target"><span>Scots</span></a></li><li class="interlanguage-link interwiki-simple mw-list-item" style="display: none;"><a href="https://simple.wikipedia.org/wiki/Cocoa" title="Cocoa – enkel engelsk" lang="en-simple" hreflang="en-simple" class="interlanguage-link-target"><span>Simple English</span></a></li><li class="interlanguage-link interwiki-sk mw-list-item" style="display: none;"><a href="https://sk.wikipedia.org/wiki/Kakao" title="Kakao – slovakisk" lang="sk" hreflang="sk" class="interlanguage-link-target"><span>Slovenčina</span></a></li><li class="interlanguage-link interwiki-sl mw-list-item" style="display: none;"><a href="https://sl.wikipedia.org/wiki/Kakav" title="Kakav – slovensk" lang="sl" hreflang="sl" class="interlanguage-link-target"><span>Slovenščina</span></a></li><li class="interlanguage-link interwiki-sr mw-list-item" style="display: none;"><a href="https://sr.wikipedia.org/wiki/%D0%9A%D0%B0%D0%BA%D0%B0%D0%BE" title="Какао – serbisk" lang="sr" hreflang="sr" class="interlanguage-link-target"><span>Српски / srpski</span></a></li><li class="interlanguage-link interwiki-sh mw-list-item" style="display: none;"><a href="https://sh.wikipedia.org/wiki/Kakao" title="Kakao – serbokroatisk" lang="sh" hreflang="sh" class="interlanguage-link-target"><span>Srpskohrvatski / српскохрватски</span></a></li><li class="interlanguage-link interwiki-fi mw-list-item" style="display: none;"><a href="https://fi.wikipedia.org/wiki/Kaakao" title="Kaakao – finsk" lang="fi" hreflang="fi" class="interlanguage-link-target"><span>Suomi</span></a></li><li class="interlanguage-link interwiki-tr mw-list-item" style="display: none;"><a href="https://tr.wikipedia.org/wiki/Kakao_%C3%A7ekirde%C4%9Fi" title="Kakao çekirdeği – tyrkisk" lang="tr" hreflang="tr" class="interlanguage-link-target"><span>Türkçe</span></a></li><li class="interlanguage-link interwiki-uk mw-list-item" style="display: none;"><a href="https://uk.wikipedia.org/wiki/%D0%9A%D0%B0%D0%BA%D0%B0%D0%BE-%D0%B1%D0%BE%D0%B1%D0%B8" title="Какао-боби – ukrainsk" lang="uk" hreflang="uk" class="interlanguage-link-target"><span>Українська</span></a></li><li class="interlanguage-link interwiki-yi mw-list-item" style="display: none;"><a href="https://yi.wikipedia.org/wiki/%D7%A7%D7%90%D7%A7%D7%90%D7%90" title="קאקאא – jiddisk" lang="yi" hreflang="yi" class="interlanguage-link-target"><span>ייִדיש</span></a></li><li class="interlanguage-link interwiki-zh-yue mw-list-item" style="display: none;"><a href="https://zh-yue.wikipedia.org/wiki/%E5%94%82%E5%92%95%E8%B1%86" title="唂咕豆 – kantonesisk" lang="yue" hreflang="yue" class="interlanguage-link-target"><span>粵語</span></a></li><li class="interlanguage-link interwiki-bat-smg mw-list-item" style="display: none;"><a href="https://bat-smg.wikipedia.org/wiki/Kakava" title="Kakava – samogitisk" lang="sgs" hreflang="sgs" class="interlanguage-link-target"><span>Žemaitėška</span></a></li><li class="interlanguage-link interwiki-zh mw-list-item" style=""><a href="https://zh.wikipedia.org/wiki/%E5%8F%AF%E5%8F%AF%E8%B1%86" title="可可豆 – kinesisk" lang="zh" hreflang="zh" class="interlanguage-link-target"><span>中文</span></a></li>
                    </ul>
                    <div class="after-portlet after-portlet-lang"><span class="wb-langlinks-edit wb-langlinks-link"><a href="https://www.wikidata.org/wiki/Special:EntityPage/Q208008#sitelinks-wikipedia" title="Rediger lenker til artikkelen på andre språk" class="wbc-editpage">Rediger lenker</a></span></div>
                </div>
        ...
        <div id="p-associated-pages" class="vector-menu vector-menu-tabs mw-portlet mw-portlet-associated-pages">
            <div class="vector-menu-content">
                ...
                <ul class="vector-menu-content-list">
                    ...
                    <li id="ca-nstab-main" class="selected vector-tab-noicon mw-list-item"><a href="/wiki/Kakao" title="Vis innholdssiden [Alt+Shift+c]" accesskey="c"><span>Artikkel</span></a></li><li id="ca-talk" class="vector-tab-noicon mw-list-item"><a href="/wiki/Diskusjon:Kakao" rel="discussion" title="Diskusjon om innholdssiden [Alt+Shift+t]" accesskey="t"><span>Diskusjon</span></a></li>
                </ul>
        ...
        <div id="p-views" class="vector-menu vector-menu-tabs mw-portlet mw-portlet-views">
            <div class="vector-menu-content">
                ...
                <ul class="vector-menu-content-list">
                    ...
                    <li id="ca-view" class="selected vector-tab-noicon mw-list-item"><a href="/wiki/Kakao"><span>Les</span></a></li><li id="ca-ve-edit" class="vector-tab-noicon mw-list-item"><a href="/w/index.php?title=Kakao&amp;veaction=edit" title="Rediger siden [Alt+Shift+v]" accesskey="v"><span>Rediger</span></a></li><li id="ca-edit" class="collapsible vector-tab-noicon mw-list-item"><a href="/w/index.php?title=Kakao&amp;action=edit" title="Rediger kildekoden for denne siden [Alt+Shift+e]" accesskey="e"><span>Rediger kilde</span></a></li><li id="ca-history" class="vector-tab-noicon mw-list-item"><a href="/w/index.php?title=Kakao&amp;action=history" title="Tidligere sideversjoner av denne siden [Alt+Shift+h]" accesskey="h"><span>Vis historikk</span></a></li>
                </ul>
        ...
        <div id="p-cactions" class="vector-menu mw-portlet mw-portlet-cactions emptyPortlet vector-has-collapsible-items" title="Flere alternativer">
            ...
            <div class="vector-menu-content">
                ...
                <ul class="vector-menu-content-list">
                    ...
                    <li id="ca-more-view" class="selected vector-more-collapsible-item mw-list-item"><a href="/wiki/Kakao"><span>Les</span></a></li><li id="ca-more-ve-edit" class="vector-more-collapsible-item mw-list-item"><a href="/w/index.php?title=Kakao&amp;veaction=edit" title="Rediger siden [Alt+Shift+v]" accesskey="v"><span>Rediger</span></a></li><li id="ca-more-edit" class="collapsible vector-more-collapsible-item mw-list-item"><a href="/w/index.php?title=Kakao&amp;action=edit" title="Rediger kildekoden for denne siden [Alt+Shift+e]" accesskey="e"><span>Rediger kilde</span></a></li><li id="ca-more-history" class="vector-more-collapsible-item mw-list-item"><a href="/w/index.php?title=Kakao&amp;action=history"><span>Vis historikk</span></a></li>
                </ul>
        ...
        <div id="p-tb" class="vector-menu mw-portlet mw-portlet-tb">
            ...
            <div class="vector-menu-content">
                ...
                <ul class="vector-menu-content-list">
                    ...
                    <li id="t-whatlinkshere" class="mw-list-item"><a href="/wiki/Spesial:Lenker_hit/Kakao" title="Liste over alle wikisider som lenker hit [Alt+Shift+j]" accesskey="j"><span>Lenker hit</span></a></li><li id="t-recentchangeslinked" class="mw-list-item"><a href="/wiki/Spesial:Relaterte_endringer/Kakao" rel="nofollow" title="Siste endringer i sider som blir lenket fra denne siden [Alt+Shift+k]" accesskey="k"><span>Relaterte endringer</span></a></li><li id="t-specialpages" class="mw-list-item"><a href="/wiki/Spesial:Spesialsider" title="Liste over alle spesialsider [Alt+Shift+q]" accesskey="q"><span>Spesialsider</span></a></li><li id="t-permalink" class="mw-list-item"><a href="https://no.wikipedia.org/w/index.php?title=Kakao&amp;oldid=23034788" title="Permanent lenke til denne versjonen av siden"><span>Permanent lenke</span></a></li><li id="t-info" class="mw-list-item"><a href="/w/index.php?title=Kakao&amp;action=info" title="Mer informasjon om denne siden"><span>Sideinformasjon</span></a></li><li id="t-cite" class="mw-list-item"><a href="/w/index.php?title=Spesial:Siteringshjelp&amp;page=Kakao&amp;id=23034788&amp;wpFormIdentifier=titleform" title="Informasjon om hvordan denne siden kan siteres"><span>Siter denne siden</span></a></li><li id="t-urlshortener" class="mw-list-item"><a href="/w/index.php?title=Spesial:UrlShortener&amp;url=https%3A%2F%2Fno.wikipedia.org%2Fwiki%2FKakao" aria-haspopup="dialog"><span>Hent forkortet URL</span></a></li><li id="t-wikibase" class="mw-list-item"><a href="https://www.wikidata.org/wiki/Special:EntityPage/Q208008" title="Lenke til koblet dataregisterelement [Alt+Shift+g]" accesskey="g"><span>Wikidata-element</span></a></li>
                <li class="mw-list-item mw-list-item-js" id="wbc-editpage"><a href="https://www.wikidata.org/wiki/Special:EntityPage/Q208008#sitelinks-wikipedia" title="Rediger lenker til artikkelen på andre språk"><span>Rediger lenker til artikkelen på andre språk</span></a></li></ul>
        ...
        <div id="p-coll-print_export" class="vector-menu mw-portlet mw-portlet-coll-print_export">
            ...
            <div class="vector-menu-content">
                ...
                <ul class="vector-menu-content-list">
                    ...
                    <li id="coll-download-as-rl" class="mw-list-item"><a href="/w/index.php?title=Spesial:DownloadAsPdf&amp;page=Kakao&amp;action=show-download-screen"><span>Last ned som PDF</span></a></li><li id="t-print" class="mw-list-item"><a href="/w/index.php?title=Kakao&amp;printable=yes" title="Utskriftsvennlig versjon av denne siden [Alt+Shift+p]" accesskey="p"><span>Utskriftsvennlig versjon</span></a></li>
                </ul>
        ...
        <div id="p-wikibase-otherprojects" class="vector-menu mw-portlet mw-portlet-wikibase-otherprojects">
            ...
            <div class="vector-menu-content">
                ...
                <ul class="vector-menu-content-list">
                    ...
                    <li class="wb-otherproject-link wb-otherproject-commons mw-list-item"><a href="https://commons.wikimedia.org/wiki/Category:Cocoa_beans" hreflang="en"><span>Wikimedia Commons</span></a></li>
                </ul>
                        ...
                        <div id="bodyContent" class="vector-body ve-init-mw-desktopArticleTarget-targetContainer" aria-labelledby="firstHeading" data-mw-ve-target-container="">
                            <div class="vector-body-before-content">
                                ...
                                <div id="siteSub" class="noprint"><a href="https://nn.wikipedia.org/wiki/Kakao" title="Les om Kakao på nynorsk" lang="nn" class="superinterwiki">Artikkel på nynorsk</a></div>
                            </div>
                            <div id="contentSub"><div id="mw-content-subtitle"></div></div>
                            
                            
                            <div id="mw-content-text" class="mw-body-content"><div class="mw-content-ltr mw-parser-output" lang="nb" dir="ltr"><dl><dd><i>Denne artikkelen handler om næringsmiddelet kakao. For drikk laget av dette, se <a href="/wiki/Kakao_(drikk)" class="mw-redirect" title="Kakao (drikk)">kakao (drikk)</a>.</i></dd></dl>
        <figure class="mw-default-size" typeof="mw:File/Thumb"><a href="/wiki/Fil:Theobroma_cacao_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-137.jpg" class="mw-file-description"><img src="//upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Theobroma_cacao_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-137.jpg/250px-Theobroma_cacao_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-137.jpg" decoding="async" width="250" height="361" class="mw-file-element" srcset="//upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Theobroma_cacao_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-137.jpg/375px-Theobroma_cacao_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-137.jpg 1.5x, //upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Theobroma_cacao_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-137.jpg/500px-Theobroma_cacao_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-137.jpg 2x" data-file-width="1661" data-file-height="2398"></a><figcaption>Kakaofrukt med frø (<i>Köhlers Medizinal Pflanzen</i>, 1887)</figcaption></figure>
        <figure class="mw-default-size" typeof="mw:File/Thumb"><a href="/wiki/Fil:Cacao-pod-k4636-14.jpg" class="mw-file-description"><img src="//upload.wikimedia.org/wikipedia/commons/thumb/0/01/Cacao-pod-k4636-14.jpg/250px-Cacao-pod-k4636-14.jpg" decoding="async" width="250" height="166" class="mw-file-element" srcset="//upload.wikimedia.org/wikipedia/commons/thumb/0/01/Cacao-pod-k4636-14.jpg/375px-Cacao-pod-k4636-14.jpg 1.5x, //upload.wikimedia.org/wikipedia/commons/thumb/0/01/Cacao-pod-k4636-14.jpg/500px-Cacao-pod-k4636-14.jpg 2x" data-file-width="2700" data-file-height="1796"></a><figcaption>Frukt på kakaotreet</figcaption></figure>
        <p><b>Kakao</b> er et <a href="/wiki/N%C3%A6ringsmiddel" class="mw-redirect" title="Næringsmiddel">næringsmiddel</a> fremstilt av <a href="/wiki/Kakaotre" title="Kakaotre">kakaotreet</a> (<i>Theobroma cacao</i>). Dette blir dyrket i de tropiske delene av <a href="/wiki/Mellom-Amerika" title="Mellom-Amerika">Mellom</a>- og <a href="/wiki/S%C3%B8r-Amerika" title="Sør-Amerika">Sør-Amerika</a>, <a href="/wiki/Asia" title="Asia">Asia</a> og <a href="/wiki/Afrika" title="Afrika">Afrika</a>. <a href="/wiki/Carl_von_Linn%C3%A9" title="Carl von Linné">Carl von Linné</a> gav treet navnet Teobroma: <i>gudenes føde</i>.
        </p>
        <meta property="mw:PageProp/toc">
        <h2><span class="mw-headline" id="Bruk">Bruk</span><span class="mw-editsection"><span class="mw-editsection-bracket">[</span><a href="/w/index.php?title=Kakao&amp;veaction=edit&amp;section=1" title="Rediger avsnitt: Bruk" class="mw-editsection-visualeditor"><span>rediger</span></a><span class="mw-editsection-divider"> | </span><a href="/w/index.php?title=Kakao&amp;action=edit&amp;section=1" title="Rediger kildekoden til seksjonen Bruk"><span>rediger kilde</span></a><span class="mw-editsection-bracket">]</span></span></h2>
        <p>Kakao blir benyttet i <a href="/wiki/Drikke" title="Drikke">drikker</a>, som for eksempel <a href="/wiki/Kakao_(drikk)" class="mw-redirect" title="Kakao (drikk)">varm sjokolade</a> og <a href="/wiki/Sjokolademelk" title="Sjokolademelk">sjokolademelk</a>, og til å lage <a href="/wiki/Sjokolade" title="Sjokolade">sjokolade</a>. Det er en vanlig <a href="/wiki/Ingrediens" title="Ingrediens">ingrediens</a> i forskjellige kaker, som sjokoladekake eller brownies. Som oftest tenker man på kakao i forbindelse med søte matvarer, men blant annet i meksikansk matlaging er det ikke uvanlig å bruke kakao som ingrediens uten sukker, som for eksempel i chiligryter.
        </p>
        <h2><span class="mw-headline" id="Produksjon">Produksjon</span><span class="mw-editsection"><span class="mw-editsection-bracket">[</span><a href="/w/index.php?title=Kakao&amp;veaction=edit&amp;section=2" title="Rediger avsnitt: Produksjon" class="mw-editsection-visualeditor"><span>rediger</span></a><span class="mw-editsection-divider"> | </span><a href="/w/index.php?title=Kakao&amp;action=edit&amp;section=2" title="Rediger kildekoden til seksjonen Produksjon"><span>rediger kilde</span></a><span class="mw-editsection-bracket">]</span></span></h2>
        <p>Treet krever tropisk klima for å trives, altså cirka 20 grader nord og sør for <a href="/wiki/Ekvator" title="Ekvator">ekvatoren</a>. Største produsent i verden er <a href="/wiki/Elfenbenskysten" title="Elfenbenskysten">Elfenbenskysten</a> som står for over 1 million tonn av en totalproduksjon på vel 3 millioner tonn, altså en tredel. Andre betydelige produsenter er <a href="/wiki/Indonesia" title="Indonesia">Indonesia</a>, <a href="/wiki/Ghana" title="Ghana">Ghana</a>, <a href="/wiki/Nigeria" title="Nigeria">Nigeria</a>, <a href="/wiki/Brasil" title="Brasil">Brasil</a>, <a href="/wiki/Kamerun" title="Kamerun">Kamerun</a> og <a href="/wiki/Ecuador" title="Ecuador">Ecuador</a>. Det finnes tre hovedsorter av kakao: Forastero, Criollo, og Trinitario. Forastero står for 95% prosent av produksjonen, Criollo gir en bedre kvalitet, men lavere avkastning og er mer mottakelig for sykdommer og Trinitario er en <a href="/wiki/Hybrid" title="Hybrid">hybrid</a> av de to andre. 
        </p><p>En del kakaopulver er også behandlet med en prosess som på engelsk kalles "dutch processing". Denne prosessen fjerner en del av bitterheten i kakaoen, og gjør den mildere i smaken og mørkere i fargen. Dette er noe av grunnlaget for den særegne smaken til kjekstyper som Oreo's, som benytter det som ofte kalles sort kakao, som altså er kakao som er mye behandlet på denne måten. 
        </p>
        <h2><span class="mw-headline" id="Innholdsstoffer_i_kakao">Innholdsstoffer i kakao</span><span class="mw-editsection"><span class="mw-editsection-bracket">[</span><a href="/w/index.php?title=Kakao&amp;veaction=edit&amp;section=3" title="Rediger avsnitt: Innholdsstoffer i kakao" class="mw-editsection-visualeditor"><span>rediger</span></a><span class="mw-editsection-divider"> | </span><a href="/w/index.php?title=Kakao&amp;action=edit&amp;section=3" title="Rediger kildekoden til seksjonen Innholdsstoffer i kakao"><span>rediger kilde</span></a><span class="mw-editsection-bracket">]</span></span></h2>
        <p>Over halvparten av kakao er fett (kakaofett) og cirka 12&nbsp;% protein. Totalt er det antatt at kakao inneholder cirka 300 forskjellige stoffer, deriblant mye <a href="/wiki/Antioksidant" title="Antioksidant">antioksidanter</a>, og <a href="/wiki/Alkaloid" title="Alkaloid">alkaloidene</a> <a href="/wiki/Teobromin" title="Teobromin">teobromin</a> og <a href="/wiki/Koffein" title="Koffein">koffein</a>.
        </p>
        <h2><span class="mw-headline" id="Kakao_og_dyr">Kakao og dyr</span><span class="mw-editsection"><span class="mw-editsection-bracket">[</span><a href="/w/index.php?title=Kakao&amp;veaction=edit&amp;section=4" title="Rediger avsnitt: Kakao og dyr" class="mw-editsection-visualeditor"><span>rediger</span></a><span class="mw-editsection-divider"> | </span><a href="/w/index.php?title=Kakao&amp;action=edit&amp;section=4" title="Rediger kildekoden til seksjonen Kakao og dyr"><span>rediger kilde</span></a><span class="mw-editsection-bracket">]</span></span></h2>
        <p>Kakao og sjokolade kan være livstruende for <a href="/wiki/Tamhund" title="Tamhund">hunder</a> (trolig også for <a href="/wiki/Tamkatt" title="Tamkatt">katter</a> og <a href="/wiki/Hest" title="Hest">hester</a>), på grunn av innholdet av stoffene teobromin og koffein. For hester er kakao regnet som dopingmiddel ved konkurranser. Inntak av kakao kan blant annet forårsake <a href="/wiki/Takykardi" title="Takykardi">takykardi</a>, <a href="/wiki/Hallusinasjon" title="Hallusinasjon">hallusinasjoner</a>, alvorlig <a href="/wiki/Diar%C3%A9" title="Diaré">diaré</a>, <a href="/wiki/Epilepsi" title="Epilepsi">epileptiske</a> anfall, <a href="/wiki/Hjerteinfarkt" title="Hjerteinfarkt">hjerteinfarkt</a>, innvendige <a href="/wiki/Bl%C3%B8dning" title="Blødning">blødninger</a> eller <a href="/wiki/D%C3%B8d" title="Død">død</a>. Tegn på forgiftning opptrer vanligvis 6-12 timer etter inntak av stoffet. <a href="/wiki/LD50" title="LD50">Dødelig dose</a> av teobromin og koffein er om lag 100-200 mg/kg, men individuelle variasjoner gjør at død kan inntreffe ved langt lavere doser.<sup id="cite_ref-merck_1-0" class="reference"><a href="#cite_note-merck-1">[1]</a></sup>
        </p>
        <h2><span id="Se_ogs.C3.A5"></span><span class="mw-headline" id="Se_også">Se også</span><span class="mw-editsection"><span class="mw-editsection-bracket">[</span><a href="/w/index.php?title=Kakao&amp;veaction=edit&amp;section=5" title="Rediger avsnitt: Se også" class="mw-editsection-visualeditor"><span>rediger</span></a><span class="mw-editsection-divider"> | </span><a href="/w/index.php?title=Kakao&amp;action=edit&amp;section=5" title="Rediger kildekoden til seksjonen Se også"><span>rediger kilde</span></a><span class="mw-editsection-bracket">]</span></span></h2>
        <ul><li><a href="/wiki/Kakaotre" title="Kakaotre">Kakaotre</a></li>
        <li><a href="/wiki/Kakao_(drikk)" class="mw-redirect" title="Kakao (drikk)">Kakao (drikk)</a></li>
        <li><a rel="nofollow" class="external text" href="http://www.nifab.no/faktaark/kakao/">NIFAB – Nasjonalt informasjonssenter for alternativ behandling (UiT)</a> <a rel="nofollow" class="external text" href="https://web.archive.org/web/20111126064050/http://www.nifab.no/faktaark/kakao/">Arkivert</a> 26. november 2011 hos <a href="/wiki/Wayback_Machine" title="Wayback Machine">Wayback Machine</a>.</li></ul>
        <h2><span class="mw-headline" id="Referanser">Referanser</span><span class="mw-editsection"><span class="mw-editsection-bracket">[</span><a href="/w/index.php?title=Kakao&amp;veaction=edit&amp;section=6" title="Rediger avsnitt: Referanser" class="mw-editsection-visualeditor"><span>rediger</span></a><span class="mw-editsection-divider"> | </span><a href="/w/index.php?title=Kakao&amp;action=edit&amp;section=6" title="Rediger kildekoden til seksjonen Referanser"><span>rediger kilde</span></a><span class="mw-editsection-bracket">]</span></span></h2>
        <div class="mw-references-wrap"><ol class="references">
        <li id="cite_note-merck-1"><b><a href="#cite_ref-merck_1-0">^</a></b> <span class="reference-text"><a rel="nofollow" class="external text" href="http://www.merckvetmanual.com/mvm/index.jsp?cfile=htm/bc/211104.htm">Toxicology&nbsp;: Food Hazards&nbsp;: Chocolate</a> <a rel="nofollow" class="external text" href="https://web.archive.org/web/20160303181650/http://www.merckvetmanual.com/mvm/index.jsp?cfile=htm%2Fbc%2F211104.htm">Arkivert</a> 3. mars 2016 hos <a href="/wiki/Wayback_Machine" title="Wayback Machine">Wayback Machine</a>., Merck Veterinary Manual (besøkt 2009-08-06)</span>
        </li>
        </ol></div>
        <h2><span class="mw-headline" id="Eksterne_lenker">Eksterne lenker</span><span class="mw-editsection"><span class="mw-editsection-bracket">[</span><a href="/w/index.php?title=Kakao&amp;veaction=edit&amp;section=7" title="Rediger avsnitt: Eksterne lenker" class="mw-editsection-visualeditor"><span>rediger</span></a><span class="mw-editsection-divider"> | </span><a href="/w/index.php?title=Kakao&amp;action=edit&amp;section=7" title="Rediger kildekoden til seksjonen Eksterne lenker"><span>rediger kilde</span></a><span class="mw-editsection-bracket">]</span></span></h2>
        <ul><li><span class="bjeller" style="color: gray;cursor:help;" title="engelsk"><small>(en)</small></span> <a href="https://commons.wikimedia.org/wiki/Category:Cocoa_beans" class="extiw" title="commons:Category:Cocoa beans">Cocoa beans</a> – kategori av bilder, video eller lyd på <a href="/wiki/Wikimedia_Commons" title="Wikimedia Commons">Commons</a> <span class="noprint plainlinks wikidata-linkback wd_p373"><span class="mw-valign-text-top" typeof="mw:File/Frameless"><a href="https://www.wikidata.org/wiki/Q208008?uselang=nb#P373" title="Rediger på Wikidata"><img alt="Rediger på Wikidata" src="//upload.wikimedia.org/wikipedia/commons/thumb/8/8a/OOjs_UI_icon_edit-ltr-progressive.svg/10px-OOjs_UI_icon_edit-ltr-progressive.svg.png" decoding="async" width="10" height="10" class="mw-file-element" srcset="//upload.wikimedia.org/wikipedia/commons/thumb/8/8a/OOjs_UI_icon_edit-ltr-progressive.svg/15px-OOjs_UI_icon_edit-ltr-progressive.svg.png 1.5x, //upload.wikimedia.org/wikipedia/commons/thumb/8/8a/OOjs_UI_icon_edit-ltr-progressive.svg/20px-OOjs_UI_icon_edit-ltr-progressive.svg.png 2x" data-file-width="20" data-file-height="20"></a></span></span></li></ul>
        <div role="navigation" class="navbox" aria-labelledby="Oppslagsverk/autoritetsdata" style="padding:3px"><table class="nowraplinks hlist navbox-inner" style="border-spacing:0;background:transparent;color:inherit"><tbody><tr><th id="Oppslagsverk/autoritetsdata" scope="row" class="navbox-group" style="width:1%"><a href="/wiki/Hjelp:Autoritetsdata" title="Hjelp:Autoritetsdata">Oppslagsverk/autoritetsdata</a></th><td class="navbox-list navbox-odd" style="text-align:left;border-left-width:2px;border-left-style:solid;width:100%;padding:0px"><div style="padding:0em 0.25em"><a rel="nofollow" class="external text" href="https://www.britannica.com/topic/cocoa-bean">Encyclopædia Britannica</a> <b>·</b> <a rel="nofollow" class="external text" href="https://d-nb.info/gnd/4307580-0">GND</a> <b>·</b> <a rel="nofollow" class="external text" href="https://id.loc.gov/authorities/sh86006278">LCCN</a> <b>·</b> <a rel="nofollow" class="external text" href="https://www.bbc.co.uk/things/888f7744-b30a-4d8d-8786-0c16cb3077ad">BBC Things</a></div></td></tr></tbody></table></div>
        <!-- 
        NewPP limit report
        Parsed by mw‐api‐int.codfw.main‐65f6c54f46‐t7467
        Cached time: 20231227234957
        ...
        Lua memory usage: 4806638/52428800 bytes
        Number of Wikibase entities loaded: 6/400
        -->
        <!--
        Transclusion expansion time report (%,ms,calls,template)
        100.00%  185.506      1 -total
         66.26%  122.909      1 Mal:Autoritetsdata
         25.57%   47.432      1 Mal:Navboks
         24.63%   45.699      1 Mal:Offisielle_lenker
         23.39%   43.387      1 Mal:Navbox
          8.11%   15.051      2 Mal:Wayback
        -->
        
        <!-- Saved in parser cache with key nowiki:pcache:idhash:40279-0!canonical and timestamp 20231227234957 and revision id 23034788. Rendering was triggered because: api-parse
         -->
        </div><!--esi <esi:include src="/esitest-fa8a495983347898/content" /> --><noscript><img src="https://login.wikimedia.org/wiki/Special:CentralAutoLogin/start?type=1x1" alt="" width="1" height="1" style="border: none; position: absolute;"></noscript>
        <div class="printfooter" data-nosnippet="">Hentet fra «<a dir="ltr" href="https://no.wikipedia.org/w/index.php?title=Kakao&amp;oldid=23034788">https://no.wikipedia.org/w/index.php?title=Kakao&amp;oldid=23034788</a>»</div></div>
                            <div id="catlinks" class="catlinks" data-mw="interface"><div id="mw-normal-catlinks" class="mw-normal-catlinks"><a href="/wiki/Kategori:Kategorier" title="Kategori:Kategorier">Kategorier</a>: <ul><li><a href="/wiki/Kategori:Matingredienser" title="Kategori:Matingredienser">Matingredienser</a></li><li><a href="/wiki/Kategori:Sjokolade" title="Kategori:Sjokolade">Sjokolade</a></li><li><a href="/wiki/Kategori:N%C3%B8tter_og_fr%C3%B8" title="Kategori:Nøtter og frø">Nøtter og frø</a></li><li><a href="/wiki/Kategori:Ord_og_uttrykk_fra_nahuatl" title="Kategori:Ord og uttrykk fra nahuatl">Ord og uttrykk fra nahuatl</a></li></ul></div><div id="mw-hidden-catlinks" class="mw-hidden-catlinks mw-hidden-cats-hidden">Skjulte kategorier: <ul><li><a href="/wiki/Kategori:Artikler_med_offisielle_lenker_fra_Wikidata" title="Kategori:Artikler med offisielle lenker fra Wikidata">Artikler med offisielle lenker fra Wikidata</a></li><li><a href="/wiki/Kategori:Artikler_med_autoritetsdatalenker_fra_Wikidata" title="Kategori:Artikler med autoritetsdatalenker fra Wikidata">Artikler med autoritetsdatalenker fra Wikidata</a></li></ul></div></div>
                        </div>
                    </main>
        ...
        <footer id="footer" class="mw-footer" role="contentinfo">
            <ul id="footer-info">
            <li id="footer-info-lastmod"> Denne siden ble sist redigert 18. okt. 2022 kl. 00:56.</li>
            <li id="footer-info-copyright">Innholdet er tilgjengelig under <a href="https://creativecommons.org/licenses/by-sa/4.0/deed.no">Creative Commons-lisensen Navngivelse-DelPåSammeVilkår</a>, men ytterligere betingelser kan gjelde. Se <a href="https://foundation.wikimedia.org/wiki/Special:MyLanguage/Policy:Terms_of_Use">bruksvilkårene</a> for detaljer.</li>
        </ul>
        
            <ul id="footer-places">
            <li id="footer-places-privacy"><a href="https://foundation.wikimedia.org/wiki/Special:MyLanguage/Policy:Privacy_policy">Personvern</a></li>
            <li id="footer-places-about"><a href="/wiki/Wikipedia:Om">Om Wikipedia</a></li>
            <li id="footer-places-disclaimers"><a href="/wiki/Wikipedia:Generelle_forbehold">Forbehold</a></li>
            <li id="footer-places-wm-codeofconduct"><a href="https://foundation.wikimedia.org/wiki/Special:MyLanguage/Policy:Universal_Code_of_Conduct">Atferdsnorm</a></li>
            <li id="footer-places-developers"><a href="https://developer.wikimedia.org">Utviklere</a></li>
            <li id="footer-places-statslink"><a href="https://stats.wikimedia.org/#/no.wikipedia.org">Statistikk</a></li>
            <li id="footer-places-cookiestatement"><a href="https://foundation.wikimedia.org/wiki/Special:MyLanguage/Policy:Cookie_statement">Erklæring om informasjonskapsler</a></li>
            <li id="footer-places-mobileview"><a href="//no.m.wikipedia.org/w/index.php?title=Kakao&amp;mobileaction=toggle_view_mobile" class="noprint stopMobileRedirectToggle">Mobilvisning</a></li>
        <li style="display: none;"><a href="#">Tilpass forhåndsvisningen</a></li></ul>
        ...
        <script>(RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgHostname":"mw1354","wgBackendResponseTime":194,"wgPageParseReport":{"limitreport":{"cputime":"0.178","walltime":"0.221","ppvisitednodes":{"value":831,"limit":1000000},"postexpandincludesize":{"value":6622,"limit":2097152},"templateargumentsize":{"value":394,"limit":2097152},"expansiondepth":{"value":8,"limit":100},"expensivefunctioncount":{"value":5,"limit":500},"unstrip-depth":{"value":0,"limit":20},"unstrip-size":{"value":690,"limit":5000000},"entityaccesscount":{"value":6,"limit":400},"timingprofile":["100.00%  185.506      1 -total"," 66.26%  122.909      1 Mal:Autoritetsdata"," 25.57%   47.432      1 Mal:Navboks"," 24.63%   45.699      1 Mal:Offisielle_lenker"," 23.39%   43.387      1 Mal:Navbox","  8.11%   15.051      2 Mal:Wayback"]},"scribunto":{"limitreport-timeusage":{"value":"0.123","limit":"10.000"},"limitreport-memusage":{"value":4806638,"limit":52428800}},"cachereport":{"origin":"mw-api-int.codfw.main-65f6c54f46-t7467","timestamp":"20231227234957","ttl":2592000,"transientcontent":false}}});});</script>
        <script type="application/ld+json">{"@context":"https:\/\/schema.org","@type":"Article","name":"Kakao","url":"https:\/\/no.wikipedia.org\/wiki\/Kakao","sameAs":"http:\/\/www.wikidata.org\/entity\/Q208008","mainEntity":"http:\/\/www.wikidata.org\/entity\/Q208008","author":{"@type":"Organization","name":"Bidragsytere til Wikimedia-prosjektene"},"publisher":{"@type":"Organization","name":"Wikimedia Foundation, Inc.","logo":{"@type":"ImageObject","url":"https:\/\/www.wikimedia.org\/static\/images\/wmf-hor-googpub.png"}},"datePublished":"2005-03-21T12:51:46Z","dateModified":"2022-10-17T23:56:54Z","image":"https:\/\/upload.wikimedia.org\/wikipedia\/commons\/d\/d4\/Theobroma_cacao_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-137.jpg"}</script>
...
.cdx-typeahead-search--expanded .cdx-typeahead-search__input .cdx-text-input {
  border-bottom-left-radius:0;
  border-bottom-right-radius:0
}
...
.vector-icon.mw-ui-icon-wikimedia-bell {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=bell&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-bell-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=bell&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-tray {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=tray&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-tray-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=tray&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-labFlask {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=labFlask&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-labFlask-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=labFlask&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-language {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=language&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-language-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=language&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-sandbox {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=sandbox&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-sandbox-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=sandbox&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-listBullet {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=listBullet&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-listBullet-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=listBullet&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-close {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=close&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-close-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=close&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-ellipsis {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=ellipsis&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-ellipsis-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=ellipsis&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-heart {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=heart&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-heart-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=heart&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-logIn {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=logIn&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-logIn-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=logIn&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-logOut {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=logOut&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-logOut-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=logOut&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-search {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=search&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-search-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=search&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-settings {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=settings&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-settings-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=settings&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-menu {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=menu&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-menu-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=menu&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-imageGallery {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=imageGallery&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-imageGallery-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=imageGallery&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-star {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=star&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-star-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=star&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-halfStar {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=halfStar&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-halfStar-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=halfStar&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-unStar {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=unStar&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-unStar-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=unStar&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-expand {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=expand&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-expand-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=expand&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-userAdd {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=userAdd&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-userAdd-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=userAdd&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-userAvatar {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=userAvatar&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-userAvatar-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=userAvatar&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-userContributions {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=userContributions&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-userContributions-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=userContributions&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-userGroup {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=userGroup&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-userGroup-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=userGroup&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-userTalk {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=userTalk&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-userTalk-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=userTalk&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-userTemporary {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=userTemporary&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-userTemporary-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=userTemporary&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-watchlist {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=watchlist&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
.vector-icon.mw-ui-icon-wikimedia-watchlist-progressive {
  background-image:url(/w/load.php?modules=skins.vector.icons&image=watchlist&variant=progressive&format=original&lang=nb&skin=vector-2022&version=3ht3e)
}
...
@media screen {
  ...
  .mw-parser-output a.external {
    background-image:url(/w/skins/Vector/resources/skins.vector.styles/images/link-external-small-ltr-progressive.svg?30a3a);
...
@media screen {
  ...
  .vector-feature-zebra-design-enabledhtml {
    scroll-padding-top:75px
  }
  ...
  .vector-feature-zebra-design-enabled .parsoid-body {
    direction:ltr
  }
  .vector-feature-zebra-design-enabled .mw-body .firstHeading {
    word-wrap:break-word;
    margin-bottom:0
  }
  .vector-feature-zebra-design-enabled .mw-header {
    position:relative;
    z-index:3
  }
  .vector-feature-zebra-design-enabled #mw-content-text {
    margin-top:16px
  }
  .vector-feature-zebra-design-enabled .mw-indicators {
    z-index:1
  }
  ...
  .vector-feature-zebra-design-enabled .vector-page-titlebar-blank::after {
    content:none
  }
  .vector-feature-zebra-design-enabled .vector-body-before-content {
    overflow:hidden
  }
  .vector-feature-zebra-design-enabled .vector-body-before-content .mw-indicators {
    margin-top:8px
  }
  .vector-feature-zebra-design-enabled .mw-body .mw-portlet-lang {
    float:right
  }
  ...
  .vector-feature-zebra-design-enabled #contentSub:not(:empty),
  .vector-feature-zebra-design-enabled #contentSub2 {
    font-size:0.875rem;
    color:#54595d;
    width:auto;
    margin:8px 0 0
  ...
  .vector-feature-zebra-design-enabled.vector-feature-limited-width-clientpref-0 .mw-page-container,
  .vector-feature-zebra-design-enabled.vector-feature-limited-width-clientpref-0 .vector-sticky-header,
  .vector-feature-zebra-design-enabled.vector-feature-limited-width-clientpref-0 .mw-header {
    max-width:none
  }
  .vector-feature-zebra-design-enabled .skin--responsive .mw-page-container {
    min-width:auto
  }
  .vector-feature-zebra-design-enabled.vector-feature-main-menu-pinned-disabled.vector-toc-not-available .mw-page-container-inner,
  .vector-feature-zebra-design-enabled.vector-feature-main-menu-pinned-disabled.vector-feature-toc-pinned-clientpref-0 .mw-page-container-inner {
    grid-template-columns:minmax(0,1fr);
    grid-template-areas:'siteNotice' 'pageContent' 'columnStart' 'footer'
  }
  .vector-feature-zebra-design-enabled.vector-feature-main-menu-pinned-disabled.vector-toc-not-available .mw-page-container-inner .mw-body,
  .vector-feature-zebra-design-enabled.vector-feature-main-menu-pinned-disabled.vector-feature-toc-pinned-clientpref-0 .mw-page-container-inner .mw-body {
    justify-content:center
  }
  .vector-feature-zebra-design-enabled .vector-column-start .vector-sticky-pinned-container {
    margin-left:-12px
  }
  .vector-feature-zebra-design-enabled .mixin-toc-below-page-title {
    position:fixed;
    top:12px;
    left:12px;
    margin:0;
  ...
  .vector-feature-zebra-design-enabled.client-nojs.vector-feature-toc-pinned-clientpref-0 .vector-page-titlebar-toc {
    margin-right:8px
  }
  .vector-feature-zebra-design-enabled.client-nojs.vector-feature-toc-pinned-clientpref-0 .vector-page-titlebar-toc .vector-dropdown-content {
    max-width:none
  }
  .vector-feature-zebra-design-enabled.client-nojs.vector-feature-toc-pinned-clientpref-0 .vector-page-titlebar-toc .vector-toc {
    width:max-content;
    min-width:200px;
    max-width:min(0.85 * 59.25rem,75vw)
  }
  .vector-feature-zebra-design-enabled .vector-dropdown {
    position:relative
  }
  .vector-feature-zebra-design-enabled .vector-dropdown .vector-dropdown-label:not(.cdx-button--icon-only) {
    display:inline-flex;
    align-items:center
  }
  ...
  .vector-feature-zebra-design-enabled .vector-dropdown .vector-dropdown-checkbox {
    cursor:pointer;
    position:absolute;
    top:0;
    left:0;
  ...
  .vector-feature-zebra-design-enabled .vector-dropdown .vector-dropdown-checkbox:checked ~ .vector-dropdown-content {
    opacity:1;
    visibility:visible;
    height:auto
  }
  ...
  .vector-feature-zebra-design-enabled .vector-pinnable-element .mw-list-item,
  .vector-feature-zebra-design-enabled .vector-dropdown-content .mw-list-item {
    padding:0
  }
  .vector-feature-zebra-design-enabled .vector-pinnable-element .mw-list-item a,
  .vector-feature-zebra-design-enabled .vector-dropdown-content .mw-list-item a {
    display:flex;
    align-items:center;
    padding:6px 0;
    color:#3366cc
  }
  .vector-feature-zebra-design-enabled .vector-pinnable-element .mw-list-item a:not(.mw-selflink):visited,
  .vector-feature-zebra-design-enabled .vector-dropdown-content .mw-list-item a:not(.mw-selflink):visited {
    color:#3366cc
  }
  .vector-feature-zebra-design-enabled .vector-pinnable-element .mw-list-item a .vector-icon,
  .vector-feature-zebra-design-enabled .vector-dropdown-content .mw-list-item a .vector-icon {
    margin-right:6px
  }
  .vector-feature-zebra-design-enabled .vector-pinnable-element .mw-list-item a.selected a,
  .vector-feature-zebra-design-enabled .vector-dropdown-content .mw-list-item a.selected a,
  .vector-feature-zebra-design-enabled .vector-pinnable-element .mw-list-item a.selected a:visited,
  .vector-feature-zebra-design-enabled .vector-dropdown-content .mw-list-item a.selected a:visited {
    color:#202122
  }
  .vector-feature-zebra-design-enabled.vector-feature-main-menu-pinned-enabled .vector-header-start .vector-main-menu-landmark,
  .vector-feature-zebra-design-enabled.vector-feature-main-menu-pinned-disabled .vector-main-menu-container .vector-main-menu-landmark {
    display:none
  }
  .vector-feature-zebra-design-enabled .vector-main-menu #p-navigation .vector-menu-heading {
    display:none
  }
  .vector-feature-zebra-design-enabled .vector-main-menu .vector-main-menu-action-opt-out a,
  .vector-feature-zebra-design-enabled .vector-main-menu .vector-main-menu-action-lang-alert .vector-main-menu-action-content {
    display:flex;
    align-items:center;
    padding:6px 0
  }
  .vector-feature-zebra-design-enabled .vector-main-menu .vector-main-menu-action-opt-out a:not(.mw-selflink):visited,
  .vector-feature-zebra-design-enabled .vector-main-menu .vector-main-menu-action-lang-alert .vector-main-menu-action-content:not(.mw-selflink):visited {
    color:#3366cc
  }
  .vector-feature-zebra-design-enabled .vector-main-menu .vector-main-menu-action-opt-out a .vector-icon,
  .vector-feature-zebra-design-enabled .vector-main-menu .vector-main-menu-action-lang-alert .vector-main-menu-action-content .vector-icon {
    margin-right:6px
  }
  .vector-feature-zebra-design-enabled .vector-main-menu .vector-main-menu-action-opt-out a.selected a,
  .vector-feature-zebra-design-enabled .vector-main-menu .vector-main-menu-action-lang-alert .vector-main-menu-action-content.selected a,
  .vector-feature-zebra-design-enabled .vector-main-menu .vector-main-menu-action-opt-out a.selected a:visited,
  .vector-feature-zebra-design-enabled .vector-main-menu .vector-main-menu-action-lang-alert .vector-main-menu-action-content.selected a:visited {
    color:#202122
  }
  .vector-feature-zebra-design-enabled .vector-main-menu .vector-main-menu-action-opt-out a {
    font-weight:bold
  ...
  .client-nojs.vector-feature-zebra-design-enabled .vector-main-menu .vector-main-menu-action-lang-alert.vector-main-menu-action-lang-alert-empty {
    display:none
  }
  .vector-feature-zebra-design-enabled .vector-main-menu .vector-language-sidebar-alert {
    padding:8px;
    margin:0
  }
  .vector-feature-zebra-design-enabled .vector-pinnable-element {
    font-size:0.875rem
  }
  ...
  .vector-feature-zebra-design-enabled.vector-feature-page-tools-pinned-enabled .vector-page-toolbar-container .vector-page-tools-landmark,
  .vector-feature-zebra-design-enabled.vector-feature-page-tools-pinned-disabled .vector-column-end .vector-page-tools-landmark {
    display:none
  }
  .vector-feature-zebra-design-enabled .vector-page-tools .vector-more-collapsible-item {
    display:block
  }
  ...
  .vector-feature-zebra-design-enabled .vector-sticky-header {
    display:flex;
    align-items:center;
    justify-content:space-between;
    border-bottom:1px solid #eaecf0
  }
  .vector-feature-zebra-design-enabled .vector-sticky-header-start,
  .vector-feature-zebra-design-enabled .vector-sticky-header-end,
  .vector-feature-zebra-design-enabled .vector-sticky-header-icons,
  .vector-feature-zebra-design-enabled .vector-sticky-header-buttons,
  .vector-feature-zebra-design-enabled .vector-sticky-header-context-bar {
    display:flex;
    align-items:center
  }
  .vector-feature-zebra-design-enabled .vector-sticky-header-start {
  ...
  .vector-feature-zebra-design-enabled .vector-sticky-header-context-bar-primary wbr {
    display:none
  }
  .vector-feature-zebra-design-enabled .vector-sticky-header-buttons {
    font-size:0.875em
  ...
  .vector-feature-zebra-design-enabled .vector-sticky-header .vector-search-box {
    display:none
  }
  .vector-feature-zebra-design-enabled .vector-sticky-header.vector-header-search-toggled .vector-sticky-header-search-toggle,
  .vector-feature-zebra-design-enabled .vector-sticky-header.vector-header-search-toggled .vector-sticky-header-context-bar {
    display:none
  }
  .vector-feature-zebra-design-enabled .vector-sticky-header.vector-header-search-toggled .vector-search-box {
    display:block;
    margin-left:4px
  }
  .vector-feature-zebra-design-enabled .vector-sticky-header.vector-header-search-toggled .vector-search-box-show-thumbnail {
    margin-left:-9px
  }
  ...
  .vector-feature-zebra-design-enabled .vector-toc .vector-pinnable-header {
    margin-left:12px
  }
  .vector-feature-zebra-design-enabled .vector-toc .vector-toc-numb {
    display:none
  }
  .vector-feature-zebra-design-enabled .vector-toc .vector-toc-toggle {
    display:none;
    transition:100ms;
    position:absolute;
    left:-11px;
  ...
  .vector-feature-zebra-design-enabled .vector-toc .vector-toc-list-item-active > .vector-toc-link,
  .vector-feature-zebra-design-enabled .vector-toc .vector-toc-level-1-active:not(.vector-toc-list-item-expanded) > .vector-toc-link,
  .vector-feature-zebra-design-enabled .vector-toc .vector-toc-list-item-active.vector-toc-level-1-active > .vector-toc-link {
    color:#202122;
    font-weight:bold
  }
  .vector-feature-zebra-design-enabled .vector-toc .vector-toc-list-item-active > .vector-toc-link .vector-toc-text,
  .vector-feature-zebra-design-enabled .vector-toc .vector-toc-level-1-active:not(.vector-toc-list-item-expanded) > .vector-toc-link .vector-toc-text,
  .vector-feature-zebra-design-enabled .vector-toc .vector-toc-list-item-active.vector-toc-level-1-active > .vector-toc-link .vector-toc-text {
    width:calc(100% + 16px)
  }
  .vector-feature-zebra-design-enabled .vector-toc .vector-toc-level-1-active:not(.vector-toc-list-item-active) > .vector-toc-link {
    color:#202122
  }
  .vector-feature-zebra-design-enabled .vector-toc .vector-toc-text {
    padding:6px 0
  }
  .vector-feature-zebra-design-enabled .vector-toc .vector-toc-contents,
  .vector-feature-zebra-design-enabled .vector-toc .vector-toc-list {
    margin:0;
    list-style:none
  }
  .vector-feature-zebra-design-enabled .vector-toc .vector-toc-list-item {
    position:relative;
    list-style-type:none;
    padding-left:12px;
    margin:0
  }
  .vector-feature-zebra-design-enabled.client-js .vector-toc .vector-toc-level-1 .vector-toc-list-item {
    display:none
  }
  .vector-feature-zebra-design-enabled.client-js .vector-toc .vector-toc-level-1.vector-toc-list-item-expanded .vector-toc-list-item {
    display:block
  }
  .vector-feature-zebra-design-enabled.client-js .vector-toc .vector-toc-toggle {
    display:block
  }
  .vector-feature-zebra-design-enabled.client-js .vector-toc .vector-toc-level-1.vector-toc-list-item-expanded .vector-toc-toggle {
    transform:rotate(0deg)
  }
  .vector-feature-zebra-design-enabled.client-js body.ltr .vector-toc .vector-toc-toggle {
    transform:rotate(-90deg)
  }
  .vector-feature-zebra-design-enabled.client-js body.rtl .vector-toc .vector-toc-toggle {
    transform:rotate(90deg)
  }
  .vector-feature-zebra-design-enabled .vector-toc-landmark {
    display:none
  }
  ...
  .vector-feature-zebra-design-enabled.vector-feature-toc-pinned-clientpref-0 .vector-sticky-header-visible .vector-sticky-header-context-bar .vector-toc-landmark,
...
@media screen and (min-width:1000px) {
  ...
  .vector-feature-zebra-design-enabled .vector-sitenotice-container {
    grid-area:siteNotice
  }
  .vector-feature-zebra-design-enabled .vector-column-start {
  ...
  .vector-feature-zebra-design-enabled .mw-footer-container {
    grid-area:footer
  }
  .vector-feature-zebra-design-enabled.vector-feature-page-tools-pinned-enabled .vector-column-end,
  .vector-feature-zebra-design-enabled.vector-feature-client-prefs-pinned-enabled .vector-column-end {
    width:12.25rem
  }
  .vector-feature-zebra-design-enabled .vector-column-start,
...
@media screen and (min-width:1200px) {
  ...
  .vector-feature-zebra-design-enabled .mw-header .vector-header-start {
    grid-area:headerStart
  }
  .vector-feature-zebra-design-enabled .mw-header .vector-header-end {
    grid-area:headerEnd
  }
  .vector-feature-zebra-design-enabled.vector-feature-page-tools-pinned-enabled .vector-column-end,
  .vector-feature-zebra-design-enabled.vector-feature-client-prefs-pinned-enabled .vector-column-end {
...
@media screen and (min-width:1000px) {
  ...
  .vector-feature-zebra-design-enabled .mw-body .vector-page-titlebar {
    grid-area:titlebar
  }
  .vector-feature-zebra-design-enabled .mw-body .vector-page-toolbar {
    grid-area:toolbar
  }
  .vector-feature-zebra-design-enabled .mw-body #bodyContent {
    grid-area:content
  }
  .vector-feature-zebra-design-enabled .mw-body .vector-column-end {
    grid-area:columnEnd;
    overflow-anchor:none
  }
  .vector-feature-zebra-design-enabled.vector-feature-page-tools-pinned-enabled .mw-body,
  .vector-feature-zebra-design-enabled.vector-feature-client-prefs-pinned-enabled .mw-body {
    column-gap:24px
  }
  .vector-feature-zebra-design-enabled.vector-feature-limited-width-clientpref-0 .mw-body,
  .vector-feature-zebra-design-enabled.vector-feature-limited-width-content-disabled .mw-body {
    grid-template-columns:minmax(0,1fr) min-content
  }
}
@media screen and (max-width:999px) {
  .vector-feature-zebra-design-enabled.client-js .vector-page-titlebar-toc {
    margin-right:8px
  }
  .vector-feature-zebra-design-enabled.client-js .vector-page-titlebar-toc .vector-dropdown-content {
    max-width:none
  }
  .vector-feature-zebra-design-enabled.client-js .vector-page-titlebar-toc .vector-toc {
    width:max-content;
    min-width:200px;
    max-width:min(0.85 * 59.25rem,75vw)
  }
...
@media screen and (min-width:1000px) {
  .vector-feature-zebra-design-enabled.client-js.vector-feature-toc-pinned-clientpref-0 body:not(.vector-sticky-header-visible) .vector-page-titlebar-toc {
    margin-right:8px
  }
  .vector-feature-zebra-design-enabled.client-js.vector-feature-toc-pinned-clientpref-0 body:not(.vector-sticky-header-visible) .vector-page-titlebar-toc .vector-dropdown-content {
    max-width:none
  }
  .vector-feature-zebra-design-enabled.client-js.vector-feature-toc-pinned-clientpref-0 body:not(.vector-sticky-header-visible) .vector-page-titlebar-toc .vector-toc {
    width:max-content;
    min-width:200px;
    max-width:min(0.85 * 59.25rem,75vw)
  }
  ...
  .vector-feature-zebra-design-enabled.client-js.vector-feature-toc-pinned-clientpref-0 .vector-sticky-header-visible .vector-sticky-header-toc {
    margin-right:8px
  }
  .vector-feature-zebra-design-enabled.client-js.vector-feature-toc-pinned-clientpref-0 .vector-sticky-header-visible .vector-sticky-header-toc .vector-dropdown-content {
    max-width:none
  }
  .vector-feature-zebra-design-enabled.client-js.vector-feature-toc-pinned-clientpref-0 .vector-sticky-header-visible .vector-sticky-header-toc .vector-toc {
    width:max-content;
    min-width:200px;
    max-width:min(0.85 * 59.25rem,75vw)
  }
...
@media screen and (max-width:999px) {
  .vector-feature-zebra-design-enabled.client-nojs.vector-feature-toc-pinned-clientpref-1 .vector-sticky-pinned-container {
    position:static
  }
  .vector-feature-zebra-design-enabled.client-nojs.vector-feature-toc-pinned-clientpref-1 #vector-toc-pinned-container {
    max-height:200px
  }
}
@media screen and (max-width:999px) {
  ...
  .vector-feature-zebra-design-enabled.client-js .vector-pinned-container {
    display:none
  }
}
@media screen and (min-width:1000px) {
  .vector-feature-zebra-design-enabled.client-js .vector-pinnable-header-unpinned .vector-pinnable-header-pin-button,
  .vector-feature-zebra-design-enabled.client-js .vector-pinnable-header-pinned .vector-pinnable-header-unpin-button {
    display:inline-block
  }
}
@media screen and (min-width:720px) {
...
@media screen and (max-width:719px) {
  .vector-feature-zebra-design-enabled .vector-page-tools .vector-has-collapsible-items {
    display:block
  }
}
@media screen and (min-width:1000px) {
  .vector-feature-zebra-design-enabled.client-js.vector-sticky-header-enabled {
    scroll-padding-top:calc(3.125rem + 75px)
  }
  .vector-feature-zebra-design-enabled.client-js.vector-sticky-header-enabled .vector-sticky-header-container {
    display:flex
  }
  .vector-feature-zebra-design-enabled.client-js.vector-sticky-header-enabled .vector-sticky-header-visible .vector-sticky-header-container {
    opacity:1;
    transform:translateY(0)
  }
  .vector-feature-zebra-design-enabled.client-js.vector-sticky-header-enabled .vector-sticky-pinned-container {
    top:3.125rem;
    max-height:calc(100vh - 3.125rem - (24px * 2))
  }
  .vector-feature-zebra-design-enabled.client-js.vector-sticky-header-enabled .mw-sticky-header-element,
  .vector-feature-zebra-design-enabled.client-js.vector-sticky-header-enabled .charts-stickyhead th {
    top:3.125rem !important
  }
}
@media screen and (max-width:999px) {
  .vector-feature-zebra-design-enabled.client-js .vector-page-titlebar .vector-toc-landmark {
    display:block
  }
  .vector-feature-zebra-design-enabled.client-js .mw-table-of-contents-container.vector-toc-landmark {
    display:none
  }
}
.mw-wiki-logo {
  background-image:url(/static/images/project-logos/nowiki.png)
}
@media print {
  .firstHeading::before {
    left:auto;
...
@media (-webkit-min-device-pixel-ratio:1.5),(min-resolution:1.5dppx),(min-resolution:144dpi) {
  .mw-wiki-logo {
    background-image:url(/static/images/project-logos/nowiki-1.5x.png);
    background-size:135px auto
  }
}
@media (-webkit-min-device-pixel-ratio:2),(min-resolution:2dppx),(min-resolution:192dpi) {
  .mw-wiki-logo {
    background-image:url(/static/images/project-logos/nowiki-2x.png);
    background-size:135px auto
  }
}
