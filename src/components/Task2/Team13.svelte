...
<section>
    ...
    <div id="body">
        <img src={bilde1} alt="" />
        <div id="content" style="background-color: rgba(203, 201, 200, 0.9)">
            <h1>Opplev Norge</h1>
            <p><b>Eventyr, familieferie eller en romantisk helg?</b></p>
            <p style="margin-bottom: 0">Norge er fullt av spennende opplevelser! Planlegg turen, få</p>
            <p>inspirasjon og supre tips fra lokaltkjente.</p>
        </div>
        <div id="cookie">
            <div>
                <p style="font-size: 0.5em">Denne nettsiden bruker informasjonskapsler for å tilpasse annonser og måle og optimalisere ytelsen. Vi deler informasjon om din bruk av nettsiden med våre samarbeidspartnere. Ved å fortsette å bruke nettsiden, godtar du vår personvern- og sikkerhetspolicy. Vennligst bekreft at du samtykker til vår bruk av informasjonskapsler.</p>
                <a href="https://google.com">Personvern- og sikkerhetsvilkår</a>
            </div>
            <div style="display: flex; flex-direction: column">
                <button style="background-color: #0058EC">Ja, det er greit!</button>
                <button style="background-color: #0058EC">Kun nødvendige</button>
                <button style="background-color: white">Rediger instillinger</button>
            </div>
        </div>
    </div>
</section>
